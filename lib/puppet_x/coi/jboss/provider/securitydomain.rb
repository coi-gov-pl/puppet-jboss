...
module Puppet_X::Coi::Jboss::Provider::SecurityDomain
  ...
  def ensure_destroyer
    ...
    @secdom_destroyer  = Puppet_X::Coi::Jboss::Internal::SecurityDomainDestroyer.new(cli_executor, @compilator, @resource)
    @secdom_destroyer
  end
  ...
  def ensure_auditor
    destroyer = ensure_destroyer
    cli_executor = ensure_cli_executor
    @auditor = Puppet_X::Coi::Jboss::Internal::SecurityDomainAuditor.new(@resource, cli_executor, @compilator, destroyer)
    @auditor
  end
